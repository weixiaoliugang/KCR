...
{ 
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD; //PG8 ÊäÈë  
...
void NRF24L01_RX_Mode(void)
{
    ...
    sta=NRF24L01_Read_Reg(STATUS);  //¶ÁÈ¡×´Ì¬¼Ä´æÆ÷µÄÖµ 
  	...
  	NRF24L01_Write_Reg(WRITE_REG_NRF+CONFIG, 0x3f);//ÅäÖÃ»ù±¾¹¤×÷Ä£Ê½µÄ²ÎÊı;PWR_UP,EN_CRC,16BIT_CRC,½ÓÊÕÄ£Ê½£¬¹Ø±Õ·¢ËÍÖĞ¶Ï
...
{		
    ...
    sta=NRF24L01_Read_Reg(STATUS);  //¶ÁÈ¡×´Ì¬¼Ä´æÆ÷µÄÖµ 
  	...
  	NRF24L01_Write_Reg(WRITE_REG_NRF+RF_SETUP,0x0f);  //ÉèÖÃTX·¢Éä²ÎÊı,0dbÔöÒæ,2Mbps,µÍÔëÉùÔöÒæ¿ªÆô  	
  	NRF24L01_Write_Reg(WRITE_REG_NRF+CONFIG,0x3e);    //ÅäÖÃ»ù±¾¹¤×÷Ä£Ê½µÄ²ÎÊı;PWR_UP,EN_CRC,16BIT_CRC,½ÓÊÕÄ£Ê½£¬¹Ø±Õ·¢ËÍÖĞ¶Ï
